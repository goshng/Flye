...
import aflye.polishing.alignment as aln
import aflye.polishing.polish as pol
import aflye.polishing.consensus as cons
import aflye.assembly.assemble as asm
import aflye.assembly.repeat_graph as repeat
import aflye.assembly.scaffolder as scf
from aflye.__version__ import __version__
from aflye.__build__ import __build__
import aflye.config.py_cfg as cfg
from aflye.config.configurator import setup_params, ConfigException
from aflye.utils.bytes2human import human2bytes, bytes2human
from aflye.utils.sam_parser import AlignmentException
import aflye.utils.fasta_parser as fp

# import aflye.short_plasmids.plasmids as plas
# import aflye.trestle.trestle as tres
# import aflye.trestle.graph_resolver as tres_graph
from aflye.repeat_graph.repeat_graph import RepeatGraph
from aflye.six.moves import range
...
def _usage():
    return (
        "aflye (--pacbio-raw | --pacbio-corr | --pacbio-hifi | --nano-raw |\n"
...
def main():
    ...
    args.log_file = os.path.join(args.out_dir, "aflye.log")
