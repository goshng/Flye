...
class MakeInstall(SetuptoolsInstall):
    def run(self):
        ...
        bin_files = ["dflye-modules", "dflye-minimap2", "dflye-samtools"]
...
setup(
    ...
    packages=[
        ...
        "dflye/utils",
        "dflye/repeat_graph",
        "dflye/short_plasmids",
        "dflye/trestle",
        "dflye/tests",
    ],
    package_data={"dflye": ["config/bin_cfg/*", "tests/data/*"]},
    entry_points={"console_scripts": ["dflye = dflye.main:main"]},
