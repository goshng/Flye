...
struct UnbranchingPath {
  ...
  std::string name() const { return prefix + std::to_string(id.signedId()); }
  ...
  GraphNode *&nodeLeft() { return path.front()->nodeLeft; }

  GraphNode *&nodeRight() { return path.back()->nodeRight; }
